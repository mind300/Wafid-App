...
class AppTextStyles {
  ...
  static TextStyle font13WhiBold = TextStyle(
    fontSize: 13.sp,
    fontWeight: FontWeightHelper.bold,
    color: Colors.white,
  );
  ...
  static TextStyle font13BlackMedium = TextStyle(
   ...
   static TextStyle font11_5BlackRegular = TextStyle(
    fontSize: 11.5.sp,
  ...
  static TextStyle font15BlackReqular = TextStyle(
    fontSize: 15.sp,
    fontWeight: FontWeightHelper.regular,
    color: Colors.black,
  );
  ...
  static TextStyle font40BlueBold = TextStyle(
    fontSize: 40.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.mainBlue,
  );
  ...
  static TextStyle font15AmberMedium = TextStyle(
    fontSize: 15.sp,
    fontWeight: FontWeightHelper.medium,
    color: Colors.amber,
  );
